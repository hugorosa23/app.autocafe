        ...
        <motion.div
            ...
            <div className="w-full flex items-center justify-between p-4">
                ...
                <motion.p whileTap={{ scale: 0.75 }} className="flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md
                    ...
                    Limpar <RiRefreshFill />{" "}</motion.p>
            </div>
            {/* Seção de baixo */}
            {cartItems && cartItems.length > 0 ? (
                <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                    {/* Seção de Items do Carrinho */}
                ...
                justify-evenly px-8 py-2">
                        <div className="w-full flex items-center justify-between">
                            ...
                            <p className="text-gray-400 text-lg">R$52,90</p>
                        </div>
                        <div className="w-full flex items-center justify-between">
                            <p className="text-gray-400 text-lg">Entrega:</p>
                            <p className="text-gray-400 text-lg">R$5,00</p>
                        </div>
                        ...
                        <div className="w-full flex items-center justify-between">
                            ...
                            <p className="text-gray-200 text-xl font-semibold">R$57,90</p>
                        </div>
                        ...
                        {user ? (
                            <motion.button
                                whileTap={{ scale: 0.8 }}
                                type="button"
                                className="w-full p-2 rounded-full bg-gradient-to-tr from-red-500 to-red-700 text-gray-50 text-lg my-2 hover:shadow-lg"
                            >
                                Finalizar
                            </motion.button>
                        ) : (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center gap-6">
                    ...
                    <p className="text-xl text-textColor font-semibold">Adicione items ao carrinho</p>
                </div>
            )}
