    ...
    return (
        <div
            ...
            <img src={item?.imageURL}
                className="w-20 h-20 max-2-[60px] rounded-full object-contain"
                alt="" />

            {/* Seção de nome e preço */}
            <div className="flex flex-col gap-2">
                <p className="text-base text-gray-50">{item?.title}</p>
                <p className="text-sm block text-gray-300 font-semibold"><span className="text-xs text-red-500">R$</span>{parseFloat(item?.price) * qty}</p>
            </div>
