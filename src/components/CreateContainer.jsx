...
import { MdArticle, MdAttachMoney, MdCloudUpload, MdDelete, MdFastfood } from 'react-icons/md';
...
const CreateContainer = () => {
    ...
    const uploadImage = (e) => {
        ...
        uploadTask.on('state_changed', (snapshot) => {
            ...
            console.log(error);
            setFields(true);
            setMsg('Erro ao realizar upload, tente novamente.');
            ...
            getDownloadURL(uploadTask.snapshot.ref).then(downloadURL => {
                ...
                setIsLoading(false);
                setFields(true);
                setMsg('A imagem subiu com sucesso!');
    ...
    const deleteImage = () => {
        ...
        deleteObject(deleteRef).then(() => {
            ...
            setIsLoading(false);
            setFields(true);
            setMsg('A imagem foi deletada com sucesso!');
            setAlertStatus('success')
            setTimeout(() => {
                setFields(false);
            }, 4000);
    ...
    const saveDetails = () => {
        ...
        try {
            if ((!title || !description || !imageAsset || !price || !category)) {
                setFields(true);
                setMsg('Campos obrigatórios não podem estar vazios');
                setAlertStatus('danger');
                setTimeout(() => {
                    setFields(false);
                    setIsLoading(false);
            ...
            <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
                {fields && (
                    <motion.p
                        ...
                        text-lg font-semibold ${alertStatus === "danger"
                            ...
                            <>
                                <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                                    <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p className="text-gray-500 hover:text-gray-700">Clique aqui para fazer o Upload</p>
                                    </div>
                ...
                <div className="w-full flex flex-col md:flex-row items-center gap-3">
                    <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
                        <MdArticle className="text-gray-700 text-2xl" />
                        <input
                            type="text"
                            required
                            value={description}
                ...
                <div className="flex items-center w-full">
                    ...
                    border-none outline-none bg-red-500 px-12 py-2 rounded-lg
                    text-lg text-white font-semibold" onClick={saveDetails}>Salvar</button>
                </div>
