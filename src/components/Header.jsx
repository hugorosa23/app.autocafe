                        ...
                        {isMenu && (
                            ...
                            absolute top-12 right-0">
                                {user && user.email === "hugo.rosa2304@gmail.com" && (
                                    ...
                                    transition-all durantion-100 ease-in-out text-textColor text-base" onClick={() => setIsMenu(false)}>
                                            Novo Item <MdAdd />
                                        </p>
                                    </Link>
                                )}
                                <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100
                            transition-all durantion-100 ease-in-out text-textColor text-base" onClick={logout}>
                                    Sair <MdLogout />
                                </p>
                            </motion.div>
                        )}
                    ...
                    {isMenu && (
                        <motion.div
                            ...
                            <ul
                                ...
                                duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2" onClick={() => setIsMenu(false)}>Inicio</li>
                                <li className="text-base text-textColor hover:text-headingColor
                                duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2" onClick={() => setIsMenu(false)}>Cardápio</li>
                                <li className="text-base text-textColor hover:text-headingColor
                                duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2" onClick={() => setIsMenu(false)}>Contato</li>
                                <li className="text-base text-textColor hover:text-headingColor
                                duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2" onClick={() => setIsMenu(false)}>Sobre Nós</li>
                            </ul>
