        ...
        <div
            ...
            {data && data.length > 0 ? (
                data.map((item) => (
                    <div
                        key={item?.id}
                        className="w-275 h-300 min-w-[275px] md:w-300 md:min-w-[300px] 
                    bg-cardOverlay rounded-lg py-3 px-4 my-12 backdrop-blur-lg 
                    hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
                        ...
                        <div className="w-full flex flex-col items-end justify-end">
                            ...
                            <div className="flex items-center gap-8">
                                <p className="text-md text-headingColor font-semibold"><span className="text-sm text-red-500">R$</span>{item?.price}</p>
                            </div>
                        </div>
                    </div>
                ))
                ...
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    <p className="text-xl text-headingColor font-semibold my-2">Produtos não disponíveis</p>
                </div>
            )}
        </div>
    );
